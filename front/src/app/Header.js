...
const Header = () => {
    ...
    // 버튼(로그인) 공통 스타일
    const btnStyle = {
        border: 'none', width: '103px', fontSize: '17px', fontFamily: `'Noto Sans', 'sans-serif'`, fontWeight: '700', color: fontColor
    }

    // 버튼(회원가입) 공통 스타일
    const btnStyle2 = {
        marginLeft: '9px', border: 'none', width: '107px', fontSize: '17px', fontFamily: `'Noto Sans', 'sans-serif'`, fontWeight: '700', color: fontColor
    }
            ...
            <div className="top"
                ...
                <div className="middle"
                    ...
                    <Menu mode="horizontal" 
                        ...
                        style={{
                            ...
                            backgroundColor: 'transparent', color: fontColor, width: '700px'
                        }}
                        onClick={ 
                            (e)  => goToPage(e)
                        }
                ...
                <div className='right'
                    ...
                    <div className='AuthWrap'>
                        {/* <Button ghost style={btnStyle} onClick={
                            (e) => {navigate('./dashboard')}
                            }>로그인</Button> */}
                        <Link to="/dashboard">
                            <Button ghost style={btnStyle}>
                                <span>로그인</span>
                                {/* <div className='ghostBtn' style={{ width: "100%", height: "4px" }}></div> */}
                            </Button>
                        </Link>
