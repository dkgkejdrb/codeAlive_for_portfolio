...
const MyPageMyClassroomNavigation = () => {
    const navigate = useNavigate();

    const items = [
        getItem('대시보드', 'dashboard', <Image width={36} src={dashboardDarkLogo} preview={false}/>),
        getItem('내 강의실', 'myClassRoom', <Image width={36} src={myClassRoomLogo} preview={false}/>),
        getItem('학습 Q&A', 'qa', <Image width={36} src={qaDarkLogo} preview={false}/>),
    ...
    return (<>
        ...
        <div 
            ...
            <Menu
                ...
                theme="light"
                mode="inline"
                defaultSelectedKeys={['myClassRoom']}
                items={items}
...
export default MyPageMyClassroomNavigation;