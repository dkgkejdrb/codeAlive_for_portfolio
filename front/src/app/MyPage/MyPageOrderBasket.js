...
import MyPageOrderBasketNavigation from "../../app/MyPage/MyPageOrderBasketNavigation";
import MyPageOrderBasketLogo from "../../Assets/MyPageOrderBasketLogo.png"
        ...
        >
          <Content>
            ...
            >
              <div
                className="Title"
                style={{ width: "100%", height: "58px", display: "flex" }}
              >
                <div className="Wrap">
                  <Image
                    width={225}
                    src={MyPageOrderBasketLogo}
                    preview={false}
                  ></Image>
                </div>
              </div>
              <div
                className="orderBasketWrap"
                style={{
                  marginTop: "48px",
                  width: "100%",
                  height: "100%",
...
export default MyPageOrderBasket;