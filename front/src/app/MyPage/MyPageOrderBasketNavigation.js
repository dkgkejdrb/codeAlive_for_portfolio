...
const MyPageOrderBasketNavigation = () => {
    ...
    const items = [
        ...
        getItem('장바구니', 'orderBasket', <Image width={36} src={orderBasketLogo} preview={false}/>),
    ...
    return (<>
        ...
        <div 
            ...
            <Menu
                ...
                theme="light"
                mode="inline"
                defaultSelectedKeys={['orderBasket']}
                items={items}
...
export default MyPageOrderBasketNavigation;