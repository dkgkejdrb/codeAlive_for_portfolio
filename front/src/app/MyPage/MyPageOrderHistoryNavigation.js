...
const MyPageOrderHistoryNavigation = () => {
    ...
    const items = [
        ...
        getItem('결제내역', 'orderHistory', <Image width={36} src={orderHistoryLogo} preview={false}/>),
    ];
...
export default MyPageOrderHistoryNavigation;